"""
Module 01 — Basics
Fill in each TODO. Run this file to check your output against the
expected comments. Compare against solutions.py only after trying.
"""

# TODO 1: Print "Hello, Python" to the console.
print("Hello, Python")
